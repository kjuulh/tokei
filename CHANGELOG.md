...
## [15.0.0](https://github.com/kjuulh/tokei/compare/v14.0.0...v15.0.0) - 2026-09-06

### Added

- Added C3 programming language. ([#1319](https://github.com/kjuulh/tokei/pull/1319))

### Other

- Add support for Godot TextScene(tscn)
- Update strum/strum_macros to 0.28.0
- Bump toml from 0.8 to 0.9 ([#1346](https://github.com/kjuulh/tokei/pull/1346))
- Add Laravel Blade language support ([#1353](https://github.com/kjuulh/tokei/pull/1353))
- Add Djot language support in languages.json ([#1321](https://github.com/kjuulh/tokei/pull/1321))
- Update strum/strum_macros to 0.27.2 ([#1316](https://github.com/kjuulh/tokei/pull/1316))
